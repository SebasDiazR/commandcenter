...
export interface Conference {
  ...
  notes?: string;          // BD planning context (attendees, speaking/sponsorship, coordination)
}
...
export const CONFERENCES: Conference[] = [
  ...
  { id: "tcuf-2026", name: "TCUF 2026 Conference", organizer: "TCUF – Association of Texas College & University Facilities Professionals", city: "Houston", state: "TX", country: "USA", venue: "Hyatt Regency Houston Downtown", startDate: "2026-09-23", endDate: "2026-09-25", url: "https://t-cuf.org/", relevance: "higher-ed facilities", lat: 29.7604, lng: -95.3698, confidence: "high", notes: "TX Region priority. Attendees & speaking opportunities being confirmed. Call for project (board) presentation — team + marketing to decide which project to present. Passed on the bar-crawl sponsorship ($10k — difficult timing/venue). Note: Houston Open House falls the same week." },
  { id: "cappa-2026", name: "CAPPA 2026 Regional Conference", organizer: "CAPPA – Central Region of APPA", city: "Branson", state: "MO", country: "USA", venue: "Chateau on the Lake Resort & Conference Center", startDate: "2026-09-27", endDate: "2026-09-30", url: "https://www.appa.org/events/cappa-2026-regional-conference", relevance: "higher-ed facilities", lat: 36.6437, lng: -93.2185, confidence: "high", notes: "Central US regional annual conference — planning ahead. Tentative TX attendees pending budget: Ryan, Cathryn T, others TBD. Marketing materials TBD." },
